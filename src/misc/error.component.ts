...
@Component({
  ...
  <p *ngIf="!ok" class="error-item">
    <span class="error">
      <svg xmlns="http://www.w3.org/2000/svg" version="1.1" class="icon icon-error" viewBox="0 0 8 8">
    ...
    <button (click)="retryClicked()">
      <p>Retry </p>
      <svg xmlns="http://www.w3.org/2000/svg" version="1.1" class="icon icon-refresh" viewBox="0 0 8 8">
